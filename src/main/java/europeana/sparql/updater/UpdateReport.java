...
public class UpdateReport {
    ...
    /**
     * Generate text that describes the changes done to all processed datasets.
     * @return string describing all dataset changes
     */
    public String print() {
    ...
    public String printSummary() {
        ...
        s.append("Datasets: ").append(created.size()).append(" added new, ")
